...
import '../Environment/TotalWaterWithdraw.css'; // Import your CSS file here

const NegativeWaterSingle = ({ consumption, notGenerated, maxConsumption }) => {
  ...
  return (
    <div className="water-withdrawn-container">
      ...
      <div className="water-withdrawn-bars">
        <div className="water-withdrawn-bar" style={{ marginBottom: "2%", height: "50px" }}>
          <div
...
export default NegativeWaterSingle;
