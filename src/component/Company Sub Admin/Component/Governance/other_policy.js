  ...
  handleSubmit3 = (event) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        window.location.href = baseURL + "/other_policies";
      })
      ...
      .then(
        (data) => {
          this.setState({
            ...
            environmentalAccess: data.otherPolicyAccess,
          });
        },
        (error) => {
          this.setState({
    ...
    fetch(
      ...
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            otherSubAdminPolicy: data.otherPolicy,
            environmentalAccess2: data.otherPolicyAccess,
          });
        },
        (error) => {
          this.setState({
    ...
    fetch(
      ...
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            otherPolicyGlobalData: data.otherPolicy,
            environmentalAccess1: data.otherPolicyAccess,
          });
        },
        (error) => {
          this.setState({
                        ...
                        <div className="Introduction framwork_2">
                          <div className="col-md-12">
                              ...
                              {currentUser.data.role === "company_admin" && (
                                <div className="col-xxl-3 col-lg-5 col-md-12 col-12 form_x mb-3 bold">
                                  <AssignSubAdminComponent3
                                    tableName="governance_OtherPolicy"
                                    removeHeader={true}
                                  />
                                </div>
                              )}
                            ...
                            <div className="Statement">
                              {otherPolicyGlobalData.map((item, key) => (
                                  ...
                                  <div className="form-group mb-2">
                                    <div className="video_esg">
                                      <textarea
                                        ...
                                        name="description"
                                        value={description}
                                        placeholder="Leave a Description here (Max 1000 Character)"
                                        onChange={this.handleChange}
                                      ></textarea>
                              ...
                              {otherSubAdminPolicy.map((item, key) => (
                                <div className="Statement_one" key={key}>
                                  <div className="Statement_2">
                                    <p className="statement_p">
                                      {item.question}
