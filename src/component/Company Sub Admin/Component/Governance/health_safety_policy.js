...
export default class HealthSafety extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoaded: true,
      healthAndSafetyPolicy: [],
      healthAndSafetySubAdminPolicy: [],
      healthAndSafetyPolicyGlobalData: [],
      healthAndSafetyPolicyData: [],
      errorMessage: [],
      policyComment: [],
      comment: "",
      policyid: [],
  ...
  handleSubmit3 = (event) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        window.location.href = baseURL + "/Health_&_Safety_Policy";
      })
      ...
      .then(
        (data) => {
          this.setState({
            ...
            environmentalAccess: data?.healthAndSafetyPolicyAccess,
          });
        },
        (error) => {
          this.setState({
    ...
    fetch(
      ...
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            healthAndSafetySubAdminPolicy: data.healthAndSafetyPolicy,
            environmentalAccess2: data.healthAndSafetyPolicyAccess,
          });
        },
        (error) => {
          this.setState({
    ...
    fetch(
      ...
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            healthAndSafetyPolicyGlobalData: data.healthAndSafetyPolicy,
            environmentalAccess1: data.healthAndSafetyPolicyAccess,
          });
        },
        (error) => {
          this.setState({
                      ...
                      <div className="col-sm-12">
                        <div className="Introduction framwork_2">
                          <div className="col-md-12">
                            <div className="row">
                              <div className="col-xxl-9 col-lg-7 col-md-6 col-12">
                              ...
                              {currentUser.data.role === "company_admin" && (
                                <div className="col-xxl-3 col-lg-5 col-md-6 col-12 form_x mb-3 bold">
                                  <AssignSubAdminComponent3
                                    tableName="governanceHealthSafetyPolicy"
                                    removeHeader={true}
                                  />
                                </div>
                              )}
                            ...
                            <div className="Statement">
                              {healthAndSafetyPolicyGlobalData.map(
                                (item, key) => (
                              ...
                              {healthAndSafetyPolicy.map((item, key) => (
                                <div className="Statement_one" key={key}>
                                  <div className="Statement_2">
                                    <p className="statement_p">
                                      {item.question}
                              ...
                              {healthAndSafetySubAdminPolicy.map(
                                (item, key) => (
                                  <div className="Statement_one" key={key}>
                                    <div className="Statement_2">
                                      <p className="statement_p">
