...
export default class CyberTechnology extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoaded: true,
      cyberAndTechnology: [],
      cyberAndTechnologySubAdminPolicy: [],
      cyberAndTechnologyGlobalData: [],
      cyberAndTechnologyData: [],
      errorMessage: [],
      policyComment: [],
      feedback: [],
      comment: "",
  ...
  setOpen3(e) {
    ...
    fetch(
      config.API_URL +
      `getGovernanceComments/${policyid}/${commentor}?current_role=${localStorage.getItem("role")}`,
      requestOptions
    )
      .then((res) => res.json())
      .then(
  ...
  handleSubmit3 = (event) => {
    ...
    axios
      .post(
        config.API_URL +
        `sendGovernanceComments?current_role=${localStorage.getItem("role")}`,
        {
      ...
      .then((response) => {
        ...
        window.location.href = baseURL + "/Cyber_&_Technology";
      })
  ...
  handleSubmit2(event) {
    ...
    axios
      .post(
        config.API_URL + `updatePolicy/${this.state.id}?current_role=${localStorage.getItem("role")}`,
        {
          type: "cyberAndTechnology",
          question: question
        },
        { headers }
      )
  ...
  handleSubmit1(event) {
    ...
    axios
      .post(
        config.API_URL + `addNewSpecificPolicy?current_role=${localStorage.getItem("role")}`,
        {
  ...
  handleSubmit(event) {
    ...
    axios
      .post(
        config.API_URL + `submitGovernancePolicyDescription?current_role=${localStorage.getItem("role")}`,
        {
      ...
      .then(
        (response) => {
          this.setState({
            ...
            errorCode: response.data.customMessage
          });
          sweetAlert("success", response.data.message);
          if (response.data.customMessage || response.data.customMessage) {
  ...
  deleteUser = (event) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .post(
            config.API_URL + `removeGovernancePolicy?current_role=${localStorage.getItem("role")}`,
            {
              id: id,
            },
            {
  ...
  onFileChange = (event) => {
    ...
    if (event.target.files[0].type !== undefined) {
      ...
      axios
        .post(config.API_URL + `uploadGovernancePolicy?current_role=${localStorage.getItem("role")}`, formData, { headers })
        .then((response) => {
          this.setState({
            isLoaded: true,
          });
      ...
      sweetAlert('error', "Invalid File Format please check and try again later..")
    }
  };
  ...
  serverRequest() {
    ...
    fetch(config.API_URL + `getGovernanceTopics/${this.state.uuid}?current_role=${localStorage.getItem("role")}`, requestOptions)
      .then((res) => res.json())
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            cyberAndTechnology: data.cyberAndTechnology,
            environmentalAccess: data.cyberAndTechnology_Access,
          });
        },
        (error) => {
          this.setState({
  ...
  getSubAdminPolicyData(user_id) {
    ...
    fetch(
      config.API_URL + `getSubAdminPolicyData/${user_id}current_role=${localStorage.getItem("role")}`,
      requestOptions
    )
      .then((res) => res.json())
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            cyberAndTechnologySubAdminPolicy: data.cyberAndTechnology,
            environmentalAccess2: data.cyberAndTechnology_Access,
          });
        },
        (error) => {
          this.setState({
  ...
  getProfiledata() {
    ...
    fetch(`${config.API_URL}getProfileData?userId=${localStorage.getItem("user_temp_id")}&current_role=${localStorage.getItem("role")}`, requestOptions)
      .then((res) => res.json())
      .then(
        (result) => {
          this.setState({
  ...
  getGlobalPolicyData() {
    ...
    fetch(config.API_URL + `getGovernanceGlobalTopics?current_role=${localStorage.getItem("role")}`, requestOptions)
      .then((res) => res.json())
      .then(
        (data) => {
          this.setState({
            isLoaded: false,
            cyberAndTechnologyGlobalData: data.cyberAndTechnology,
            environmentalAccess1: data.cyberAndTechnology_Access,
          });
          console.log("cyberAndTechnologyGlobalData", this.state.cyberAndTechnologyGlobalData);
        },
        (error) => {
          this.setState({
            isLoaded: true,
  ...
  render() {
    const { policyComment, question, description, cyberAndTechnology, cyberAndTechnologySubAdminPolicy, cyberAndTechnologyGlobalData, environmentalAccess, environmentalAccess1, environmentalAccess2 } = this.state;
    return (
      <div>
        ...
        {this.state.isLoaded === false && (
          <div className="main_wrapper">
            <div className="tabs-top">
              <ul>
                <li>
                  <NavLink to="/governance_policies">
                    Governance Policies
                  </NavLink>
                </li>
                <li>
                ...
                <li>
                  <NavLink to="/Health_&_Safety_Policy">Health & Safety Policy</NavLink>
                </li>
                <li>
                        ...
                        <div className="Introduction framwork_2">
                          <div className="col-md-12">
                              ...
                              {currentUser.data.role === "company_admin" && (
                                <div className="col-xxl-3 col-lg-5 col-md-12 col-12 form_x mb-3 bold">
                                  <AssignSubAdminComponent3
                                    tableName="governance_CyberTechnology"
                                    removeHeader={true}
                                  />
                                </div>
                              )}
                            ...
                            <div className="Statement">
                              {cyberAndTechnologyGlobalData.map((item, key) => (
                                                ...
                                                <div className="upload_image2 d-flex align-items-center">
                                                  ...
                                                  {!item.docsFile && (
                                                    ...
                                                    >
                                                      <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M17 1.48619e-06C26.3891 6.65366e-07 34 7.6109 34 17C34 26.3891 26.3891 34 17 34C7.6109 34 -6.65366e-07 26.3891 -1.48619e-06 17C-2.30701e-06 7.6109 7.6109 2.30701e-06 17 1.48619e-06ZM17 3.4C13.3931 3.4 9.93384 4.83285 7.38334 7.38335C4.83285 9.93384 3.4 13.3931 3.4 17C3.4 20.6069 4.83285 24.0662 7.38335 26.6167C9.93384 29.1671 13.3931 30.6 17 30.6C20.6069 30.6 24.0662 29.1671 26.6167 26.6167C29.1671 24.0662 30.6 20.6069 30.6 17C30.6 13.3931 29.1671 9.93384 26.6166 7.38335C24.0662 4.83285 20.6069 3.4 17 3.4Z" fill="#A7ACC8" />
                                                        <path d="M11.4 17.25L11.65 17.25L11.65 17L11.65 11.8056L22.35 11.8056L22.35 17L22.35 17.25L22.6 17.25L24 17.25L24.25 17.25L24.25 17L24.25 10.7778C24.25 10.5132 24.1556 10.2548 23.9808 10.0606C23.8052 9.86542 23.561 9.75 23.3 9.75L10.7 9.75C10.439 9.75 10.1948 9.86542 10.0192 10.0606C9.84435 10.2548 9.75 10.5132 9.75 10.7778L9.75 17L9.75 17.25L10 17.25L11.4 17.25ZM21.2 19.0833L17.95 19.0833L17.95 13.8889L17.95 13.6389L17.7 13.6389L16.3 13.6389L16.05 13.6389L16.05 13.8889L16.05 19.0833L12.8 19.0833L12.2387 19.0833L12.6142 19.5006L16.8142 24.1672L17 24.3737L17.1858 24.1672L21.3858 19.5006L21.7613 19.0833L21.2 19.0833Z" fill="#A7ACC8" stroke="#A7ACC8" strokeWidth="0.5" />
                                                      </svg>
                                                    </i>
                                                  )}
                                                  {environmentalAccess1 &&
                                                    item.docsFile && (
                                                      <div className="upload_image2 d-flex align-items-center">
                                                        ...
                                                        <path d="M22.6 16.75H22.35V17V22.1944H11.65V17V16.75H11.4H10H9.75V17V23.2222C9.75 23.4868 9.84435 23.7452 10.0192 23.9394C10.1948 24.1346 10.439 24.25 10.7 24.25H23.3C23.561 24.25 23.8052 24.1346 23.9808 23.9394C24.1556 23.7452 24.25 23.4868 24.25 23.2222V17V16.75H24H22.6ZM12.8 14.9167H16.05V20.1111V20.3611H16.3H17.7H17.95V20.1111V14.9167H21.2H21.7613L21.3858 14.4994L17.1858 9.83276L17 9.62629L16.8142 9.83276L12.6142 14.4994L12.2387 14.9167H12.8Z" fill="#A7ACC8" stroke="#A7ACC8" stroke-width="0.5" />
                                                      </svg> */}
                                                  ...
                                                  {environmentalAccess1 &&
                                                    !item.docsFile && (
                                                      <div className="upload_image2 d-flex align-items-center"><svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M17 34C7.6109 34 0 26.3891 0 17C0 7.6109 7.6109 0 17 0C26.3891 0 34 7.6109 34 17C34 26.3891 26.3891 34 17 34ZM17 30.6C20.6069 30.6 24.0662 29.1671 26.6167 26.6167C29.1671 24.0662 30.6 20.6069 30.6 17C30.6 13.3931 29.1671 9.93384 26.6167 7.38335C24.0662 4.83285 20.6069 3.4 17 3.4C13.3931 3.4 9.93384 4.83285 7.38335 7.38335C4.83285 9.93384 3.4 13.3931 3.4 17C3.4 20.6069 4.83285 24.0662 7.38335 26.6167C9.93384 29.1671 13.3931 30.6 17 30.6Z" fill="#A7ACC8" />
                                                        <path d="M22.6 16.75H22.35V17V22.1944H11.65V17V16.75H11.4H10H9.75V17V23.2222C9.75 23.4868 9.84435 23.7452 10.0192 23.9394C10.1948 24.1346 10.439 24.25 10.7 24.25H23.3C23.561 24.25 23.8052 24.1346 23.9808 23.9394C24.1556 23.7452 24.25 23.4868 24.25 23.2222V17V16.75H24H22.6ZM12.8 14.9167H16.05V20.1111V20.3611H16.3H17.7H17.95V20.1111V14.9167H21.2H21.7613L21.3858 14.4994L17.1858 9.83276L17 9.62629L16.8142 9.83276L12.6142 14.4994L12.2387 14.9167H12.8Z" fill="#A7ACC8" stroke="#A7ACC8" stroke-width="0.5" />
                                                      </svg>
                                        ...
                                        <span className="statement_check">
                                          {(() => {
                                            switch (item.status) {
                                              ...
                                              case 2:
                                                return (
                                                  <i id={item.feedback} onClick={(e) => this.setOpen4(e)} className="redInfo red far fa-info-circle"></i>
                                                );
                                              case 3:
                                                return;
                                              default:
                              ...
                              <Modal open={this.state.setOpen3} className="feedback2 feedback3 iframe_modal">
                                ...
                                <form onSubmit={this.handleSubmit3}>
                                  <Modal.Content>
                                    <Modal.Description>
                                      ...
                                      <span className="headertitle">Please enter your comments below</span>
                                  ...
                                  <Modal.Actions>
                                    ...
                                    <Button onClick={() => this.onClose3(false)}>
                                      Cancel
                                    </Button>
                                  </Modal.Actions>
                                </form>
                              </Modal>
                              <Modal open={this.state.setOpen4} className="feedback2 feedback3 iframe_modal">
                                ...
                                <Modal.Actions>
                                  ...
                                  <Button onClick={() => this.onClose4(false)}>
                                    Close
                                  </Button>
                                </Modal.Actions>
                              </Modal>
                              {cyberAndTechnology.map((item, key) => (
                                <div className="Statement_one" key={key}>
                                  <div className="Statement_2">
                                    <p className="statement_p">
                                      {item.question}
                                      ...
                                      >
                                        {" "}
                                        <i id={item.id} data-value={item.question} className="fas fa-pen-square"></i>
                                      </span>
                                      <span
                                        className={
                                          item.description || item.description
                                              ...
                                              return (
                                                <div className="upload_image2 d-flex align-items-center">
                                                  {item.docsFile && (
                                                    ...
                                                    >
                                                      <i className="fas fa-arrow-down i-can mx-2" />
                                                    </a>
                                                  )}
                                                  {/* {!item.docsFile && (
                                                    <i
                              ...
                              {cyberAndTechnologySubAdminPolicy.map((item, key) => (
                                <div className="Statement_one" key={key}>
                                  <div className="Statement_2">
                                    <p className="statement_p">
                                      {item.question}
