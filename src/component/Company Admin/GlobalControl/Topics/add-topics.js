                                ...
                                <form name="form" onSubmit={this.handleSubmit}>
                                  <div className="business_detail">
                                    ...
                                    <div className="row">
                                      ...
                                      <div className="col-lg-6 col-xs-6">
                                        <div className="form-group pb-3">
                                          <label htmlFor="title" className="mb-2" > Topic Heading </label>
                                      ...
                                      <div className="form-group">
                                        <label htmlFor="question" className="mb-2" > Topic Description* </label>
                                        <textarea type="text" className="form-control" id="question" placeholder="Write Topic title" name="title" onChange={this.handleChange} />
                                      </div>
                                    </div>
                                  </div>
                                  <div className="global_link mx-0 my-3">
                                    <button type="submit" className="page_width page_save" > ADD NOW </button>
                                  </div>
                                </form>
                              </div>
                            </div>
