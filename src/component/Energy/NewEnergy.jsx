...
const NewEnergy = () => {
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            const { isSuccess } = await apiCall(
                `${config.POSTLOGIN_API_URL_COMPANY}publishGraph/${graphId}`,
                {},
                {},
                "DELETE"
            );
    ...
    const styles = {
        ...
        title: {
            fontSize: '32px',
            fontWeight: '700',
            background: 'linear-gradient(135deg, #3f88a5 0%, #2a5f75 100%)',
        ...
        refreshButton: {
            ...
            boxShadow: '0 4px 15px rgba(63, 136, 165, 0.4)',
    ...
    return (
        <div style={styles.container}>
            <div style={styles.header}>
                <h1 style={styles.title}>Energy Analytics Dashboard</h1>
                <button 
                    style={styles.refreshButton}
                    onClick={getPublishedGraphs}
                    disabled={loading}
                    onMouseOver={(e) => {
                        if (!loading) {
                            e.currentTarget.style.transform = 'scale(1.05)';
                            e.currentTarget.style.boxShadow = '0 6px 20px rgba(63, 136, 165, 0.5)';
                        }
                    }}
                    onMouseOut={(e) => {
                        if (!loading) {
                            e.currentTarget.style.transform = 'scale(1)';
                            e.currentTarget.style.boxShadow = '0 4px 15px rgba(63, 136, 165, 0.4)';
                        }
                    }}
                >
                ...
                {loading ? (
                    ...
                    <div style={styles.emptyContainer}>
                        ...
                        <div style={styles.emptyText}>
                            Your published energy analytics will appear here.<br />
