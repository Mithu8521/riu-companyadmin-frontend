...
import '../Environment/Renewable.css'; // Import your CSS file here

const GreenEnergyPurchaseSingle = ({ consumption, notGenerated, maxConsumption }) => {
...
export default GreenEnergyPurchaseSingle;
