...
import SummaryIPCCComponent from "./components/SummaryIPCCComponent";

const ScopeOneIPCC = (props) => {
  ...
  // Updated useFilters hook with scope1Data
  const {
    ...
    handleFilterApply,
    handleFilterReset,
  } = useFilters(emissionEntries, scope1Data);

  // Dynamically generate categories from scope1Data with better labeling and styling
  const categories = useMemo(() => {
    ...
    const iconMap = {
      stationary: <FiActivity className="w-4 h-4" />,
      mobile: <FiTrendingUp className="w-4 h-4" />,
      fugitive: <FiBarChart className="w-4 h-4" />,
    };
    ...
    return Object.keys(scope1Data).map((key) => ({
      id: key,
      label:
        labelMap[key] ||
        key.charAt(0).toUpperCase() + key.slice(1) + " Emissions",
      icon: iconMap[key] || <FiBarChart className="w-4 h-4" />,
      gradient: "from-slate-500 via-slate-600 to-slate-700",
      bgColor: "bg-slate-50",
      textColor: "text-slate-700",
      borderColor: "border-slate-200",
  ...
  const hasActiveFilters = useMemo(() => {
    return (
      ...
      Object.values(selectedCategoryFilters).some((categoryFilter) =>
        Object.values(categoryFilter).some(
          ...
          <div className="container-fluid" style={{ padding: "2rem 1.5rem" }}>
            ...
            >
              ...
              >
                ...
                {/* No Entries State */}
                {selectedFinancialYear && totalEntries === 0 && (
                  <div className="text-center py-5">
                    <div className="mb-3">
                      <div
                        className="mx-auto mb-3 d-flex align-items-center justify-content-center animate-float"
                    ...
                    >
                      Start tracking your emissions by adding your first entry
                ...
                {selectedFinancialYear &&
                  ...
                  hasActiveFilters && (
                    <div className="text-center py-5">
                      ...
                      >
                        No emission entries match your current filter criteria.
