      ...
      (timePeriod, timeIndex) => {
        ...
        if (currentTimePeriodData && currentTimePeriodData.question_details) {
          ...
          if (
            ...
            return !isNaN(answerValue) && answerValue !== null
              ? answerValue
              : 0; // Return 0 for NaN or null
          }
        }
  ...
  const chartOptions = {
    ...
    dataLabels: {
      ...
      formatter: function (val, { seriesIndex, dataPointIndex, w }) {
        ...
        const sum = w.config.series[seriesIndex].data.reduce(
...
export default DiversityMultiYearTwo;
