...
// import './GenderPayGapAnalysisSingle.css'; // Import your CSS file here

const GenderPayGapAnalysisSingle = ({ consumption, notGenerated, maxConsumption }) => {
...
export default GenderPayGapAnalysisSingle;
