...
// import './LeadershipAndMentorship.css'; // Import your CSS file here

const LeadershipAndMentorship = ({ consumption, notGenerated, maxConsumption }) => {
...
export default LeadershipAndMentorship;
