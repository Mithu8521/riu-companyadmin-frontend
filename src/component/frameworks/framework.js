...
export default class frameworks extends Component {
  ...
  removeIndustry(id) {
    ...
    Swal.fire({
      title: "Do you want to delete this Framework?",
      ...
      if (result.isConfirmed) {
        axios
          .delete(
            config.API_URL + `deleteIndustry/${id}?current_role=${localStorage.getItem("role")}`, requestOptions,
            {
              id: id,
            }
          )
                                        ...
                                        <tr key={key}>
                                          ...
                                          <td>
                                            <NavLink
                                              ...
                                              to={"/frameworks/" + item.industryId + "/update_framework"}
                                            >
