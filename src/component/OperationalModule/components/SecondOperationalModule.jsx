              ...
              <>
                <Form.Group controlId="formModuleName">
                  ...
                  <Form.Control
                    ...
                    value={moduleName
                      ...
                      .join(" ")}
                    readOnly
                    style={{ border: "1px solid #3F88A5", borderColor: "#3F88A5" }}
                  />
                </Form.Group>
                <Form.Group
                ...
                {checkboxChecked ? (
                  ...
                  <>
                    ...
                    <Form.Group className="mt-3" style={{ width: "100%", borderColor: "#3F88A5" }}>
                      <Form.Label
                        style={{
                          width: "100%",
                          height: "100%",
...
export default SecondOperationalModal;
